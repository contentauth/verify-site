...
export class VerifyPage {
  ...
  async takeSnapshot(name: string, options: SnapshotOptions = {}) {
    ...
    const domTransformation = `(documentElement) => Array.from(documentElement.querySelectorAll('span[data-testid="Signed on"]')).forEach((el) => el.innerText = 'PERCY_DATE_REPLACEMENT');`;
