...
export async function selectEditsAndActivity(
  ...
  if (manifest.assertions instanceof Map) {
    ...
    actionsAssertion = found as ActionsAssertion | undefined;
  } else {
    actionsAssertion =
  ...
  const actions =
    actionsAssertion?.data?.actions || actionsAssertion?.actions || [];
    ...
    switch (action) {
      case 'c2pa.created':
        results.push({
          ...
          icon: `${baseUrl}/new-item-dark.svg`,
        });
        break;
      case 'c2pa.edited':
        results.push({
          id: action,
          label: 'Edited',
          description: 'The asset was modified.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
      ...
      case 'c2pa.adjustedColor':
        results.push({
          ...
          description: 'Changes made to tone, saturation, or exposure.',
          icon: `${baseUrl}/color-palette-dark.svg`,
        });
        break;
      case 'c2pa.cropped':
        results.push({
      ...
      case 'c2pa.filtered':
        results.push({
          id: action,
          label: 'Filtered',
          description: 'Appearance changed with filters and effects.',
          icon: `${baseUrl}/properties-dark.svg`,
        });
        break;
      case 'c2pa.resized':
        results.push({
          ...
          icon: `${baseUrl}/resize-dark.svg`,
        });
        break;
      case 'c2pa.orientation':
        results.push({
          id: action,
          label: 'Orientation changed',
          description: 'The asset was rotated or flipped.',
          icon: `${baseUrl}/rotate-left-outline-dark.svg`,
        });
        break;
      case 'c2pa.placed':
        results.push({
          id: action,
          label: 'Imported',
          description: 'Other assets were combined into this one.',
          icon: `${baseUrl}/import-dark.svg`,
        });
        break;
      case 'c2pa.drawing':
        results.push({
          id: action,
          label: 'Drawing',
          description: 'Digital painting or drawing was added.',
          icon: `${baseUrl}/draw-dark.svg`,
        });
        break;
      case 'c2pa.converted':
      case 'c2pa.transcoded':
        results.push({
          id: action,
          label: 'Format converted',
          description: 'The file format was changed or transcoded.',
          icon: `${baseUrl}/export-dark.svg`,
        });
        break;
      case 'c2pa.deleted':
      case 'c2pa.removed':
        results.push({
          ...
          description: 'Content was deleted or removed from the asset.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
      case 'c2pa.dubbed':
      case 'c2pa.translated':
        results.push({
          id: action,
          label: 'Audio/Text modified',
          description: 'Audio tracks or text were dubbed or translated.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
      case 'c2pa.published':
      case 'c2pa.repackaged':
        results.push({
          id: action,
          label: 'Published',
          description: 'The asset was published or repackaged.',
          icon: `${baseUrl}/export-dark.svg`,
        });
        break;
      case 'c2pa.watermarked':
        results.push({
          id: action,
          label: 'Watermarked',
          description: 'A watermark was added.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
      case 'c2pa.redacted':
        results.push({
          id: action,
          label: 'Redacted',
          description: 'Information was redacted from the manifest.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
      case 'c2pa.edited.metadata':
        results.push({
          ...
          description: 'Metadata was edited.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
      case 'c2pa.opened':
        results.push({
          ...
          icon: `${baseUrl}/folder-open-outline-dark.svg`,
        });
        break;
      case 'c2pa.saved':
        results.push({
      ...
      case 'c2pa.unknown':
        results.push({
          ...
          description: 'An unknown edit or activity occurred.',
          icon: `${baseUrl}/actions-dark.svg`,
        });
        break;
    }
