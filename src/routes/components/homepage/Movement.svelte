<div class="flex h-[720px] w-screen items-center justify-center">
  <div class="flex h-[60%] w-[60%] flex-col items-center justify-evenly">
    ...
    <div class="text-center text-sub-text text-sub-heading w-[90%]">
      ...
      does advocacy, education, thought leadership, and develops open-source
      tools to support the adoption of Content Credentials.
    </div>
    <a href="/learn-more">
      <div class="rounded-full bg-brand-red px-3 py-3 font-bold">
        Learn more
      </div>
    </a>
  </div>
