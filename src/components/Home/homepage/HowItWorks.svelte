      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <div
              class="text-hiw-label xl:text-hiw-label-xl mr-0.5 flex h-[22px] w-[22px] items-center justify-center rounded-full bg-brand-yellow px-4 py-4">
              1
            </div>
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <div
              class="text-hiw-label xl:text-hiw-label-xl mr-0.5 flex h-[22px] w-[22px] items-center justify-center rounded-full bg-brand-orange px-4 py-4">
              2
            </div>
            <h3
      ...
      <div
        ...
        <div
          ...
          <div
            class="flex w-full flex-col items-center gap-4 md:w-1/2 md:flex-row md:items-start md:justify-start">
            <div
              class="text-hiw-label xl:text-hiw-label-xl mr-0.5 flex h-[22px] w-[22px] items-center justify-center rounded-full bg-brand-red px-4 py-4">
              3
            </div>
            <h3
              class="w-full text-left text-hiw-label md:pr-10 xl:text-hiw-label-xl">
